...
static constexpr uint64_t RPC_LOG_SIZE = 6'000'000;
static constexpr uint64_t TX_COUNTER_LOG_SIZE = 700'000;
static constexpr uint64_t ANNOUNCE_THROUGHPUT_BATCH_SIZE = 100'000;
